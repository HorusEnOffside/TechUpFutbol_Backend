...
public class GraduateUserDTO extends UserPlayerDTO {

    @NotNull(message = "career is required")
    private Career career;

    public GraduateUserDTO(String name, String mail, LocalDate dateOfBirth, Gender gender, String password, Career career) {
