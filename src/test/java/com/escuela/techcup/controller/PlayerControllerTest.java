...
class PlayerControllerTest {
    ...
    private String studentPlayerDTOJson(String name, String mail, String dateOfBirth,
                                        ...
                                        Integer semester, String career,
        ...
        return String.format("""
                ...
                career == null ? "null" : "\"" + career + "\"",
                dorsal == null ? "null" : dorsal,
                position == null ? "null" : "\"" + position + "\"");
    }

    private String teacherPlayerDTOJson(String name, String mail, String dateOfBirth,
                                        String gender, String password,
                                        String career, Integer dorsal, String position) {
        return String.format("""
                {
                    "name": %s,
                    "mail": %s,
    ...
    private String graduatePlayerDTOJson(String name, String mail, String dateOfBirth,
                                         String gender, String password,
                                         String career, Integer dorsal, String position) {
        return teacherPlayerDTOJson(name, mail, dateOfBirth, gender, password, career, dorsal, position);
    }

    private String familiarPlayerDTOJson(String name, String mail, String dateOfBirth,
                                         String gender, String password,
                                         Integer dorsal, String position) {
        return String.format("""
                {
    ...
    private MockMultipartHttpServletRequestBuilder multipartWithPlayer(String path, String playerJson) {
        MockMultipartFile playerPart = new MockMultipartFile(
                "player", "", MediaType.APPLICATION_JSON_VALUE, playerJson.getBytes());
    ...
    void testCreateSportsProfileStudent_returns201() throws Exception {
        ...
        mockMvc.perform(multipartWithPlayer("/api/players/students/sports-profile",
                        studentPlayerDTOJson("Pedro", "pedro@test.com", "2001-04-12", "MALE", "pass", 5, "ENGINEERING", 9, "FORWARD")))
    ...
    void testCreateSportsProfileStudent_withoutName_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/students/sports-profile",
                        studentPlayerDTOJson(null, "pedro@test.com", "2001-04-12", "MALE", "pass", 5, "ENGINEERING", 9, "FORWARD")))
    ...
    void testCreateSportsProfileStudent_invalidMail_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/students/sports-profile",
                        studentPlayerDTOJson("Pedro", "no-es-mail", "2001-04-12", "MALE", "pass", 5, "ENGINEERING", 9, "FORWARD")))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileStudent_withoutSemester_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/students/sports-profile",
                        studentPlayerDTOJson("Pedro", "pedro@test.com", "2001-04-12", "MALE", "pass", null, "ENGINEERING", 9, "FORWARD")))
                .andExpect(status().isBadRequest());
    }

    @Test
    void testCreateSportsProfileStudent_withoutCareer_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/students/sports-profile",
                        studentPlayerDTOJson("Pedro", "pedro@test.com", "2001-04-12", "MALE", "pass", 5, null, 9, "FORWARD")))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileStudent_zeroDorsal_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/students/sports-profile",
                        studentPlayerDTOJson("Pedro", "pedro@test.com", "2001-04-12", "MALE", "pass", 5, "ENGINEERING", 0, "FORWARD")))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileStudent_withoutPosition_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/students/sports-profile",
                        studentPlayerDTOJson("Pedro", "pedro@test.com", "2001-04-12", "MALE", "pass", 5, "ENGINEERING", 9, null)))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileStudentWithPhoto_returns201() throws Exception {
        ...
        MockMultipartFile playerPart = new MockMultipartFile(
                ...
                studentPlayerDTOJson("Pedro", "pedro@test.com", "2001-04-12", "MALE", "pass", 5, "ENGINEERING", 9, "FORWARD").getBytes());
        ...
        mockMvc.perform(multipart("/api/players/students/sports-profile").file(playerPart).file(photoPart))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileStudentWithPhoto_withoutPhoto_returns201() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/students/sports-profile").file(playerPart).file(fotoVacia))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileStudentWithPhoto_corruptedImage_returns400() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/students/sports-profile").file(playerPart).file(fotoCorrupta))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileTeacher_returns201() throws Exception {
        ...
        mockMvc.perform(multipartWithPlayer("/api/players/teachers/sports-profile",
                        teacherPlayerDTOJson("Luis", "luis@test.com", "1985-03-10", "MALE", "pass", "ENGINEERING", 5, "GOALKEEPER")))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileTeacher_withoutName_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/teachers/sports-profile",
                        teacherPlayerDTOJson(null, "luis@test.com", "1985-03-10", "MALE", "pass", "ENGINEERING", 5, "GOALKEEPER")))
                .andExpect(status().isBadRequest());
    }

    @Test
    void testCreateSportsProfileTeacher_withoutCareer_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/teachers/sports-profile",
                        teacherPlayerDTOJson("Luis", "luis@test.com", "1985-03-10", "MALE", "pass", null, 5, "GOALKEEPER")))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileTeacher_zeroDorsal_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/teachers/sports-profile",
                        teacherPlayerDTOJson("Luis", "luis@test.com", "1985-03-10", "MALE", "pass", "ENGINEERING", 0, "GOALKEEPER")))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileTeacherWithPhoto_returns201() throws Exception {
        ...
        MockMultipartFile playerPart = new MockMultipartFile(
                "player", "", MediaType.APPLICATION_JSON_VALUE,
                teacherPlayerDTOJson("Luis", "luis@test.com", "1985-03-10", "MALE", "pass", "ENGINEERING", 5, "GOALKEEPER").getBytes());
        MockMultipartFile photoPart = new MockMultipartFile(
                "profilePicture", "test.jpg", MediaType.IMAGE_JPEG_VALUE, imagenBytes);

        mockMvc.perform(multipart("/api/players/teachers/sports-profile").file(playerPart).file(photoPart))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileTeacherWithPhoto_withoutPhoto_returns201() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/teachers/sports-profile").file(playerPart).file(fotoVacia))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileTeacherWithPhoto_corruptedImage_returns400() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/teachers/sports-profile").file(playerPart).file(fotoCorrupta))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileFamiliar_returns201() throws Exception {
        ...
        mockMvc.perform(multipartWithPlayer("/api/players/familiars/sports-profile",
                        familiarPlayerDTOJson("Maria", "maria@test.com", "1995-06-20", "FEMALE", "pass", 7, "DEFENDER")))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileFamiliar_withoutPosition_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/familiars/sports-profile",
                        familiarPlayerDTOJson("Maria", "maria@test.com", "1995-06-20", "FEMALE", "pass", 7, null)))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileFamiliarWithPhoto_returns201() throws Exception {
        ...
        MockMultipartFile playerPart = new MockMultipartFile(
                "player", "", MediaType.APPLICATION_JSON_VALUE,
                familiarPlayerDTOJson("Maria", "maria@test.com", "1995-06-20", "FEMALE", "pass", 7, "DEFENDER").getBytes());
        MockMultipartFile photoPart = new MockMultipartFile(
                "profilePicture", "test.jpg", MediaType.IMAGE_JPEG_VALUE, imagenBytes);

        mockMvc.perform(multipart("/api/players/familiars/sports-profile").file(playerPart).file(photoPart))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileFamiliarWithPhoto_withoutPhoto_returns201() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/familiars/sports-profile").file(playerPart).file(fotoVacia))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileFamiliarWithPhoto_corruptedImage_returns400() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/familiars/sports-profile").file(playerPart).file(fotoCorrupta))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileGraduate_returns201() throws Exception {
        ...
        mockMvc.perform(multipartWithPlayer("/api/players/graduates/sports-profile",
                        graduatePlayerDTOJson("Ana", "ana@test.com", "1998-11-05", "FEMALE", "pass", "DATA_SCIENCE", 11, "MIDFIELDER")))
                .andExpect(status().isCreated());
    }
    ...
    @Test
    void testCreateSportsProfileGraduate_withoutCareer_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/graduates/sports-profile",
                        graduatePlayerDTOJson("Ana", "ana@test.com", "1998-11-05", "FEMALE", "pass", null, 11, "MIDFIELDER")))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileGraduate_withoutPassword_returns400() throws Exception {
        mockMvc.perform(multipartWithPlayer("/api/players/graduates/sports-profile",
                        graduatePlayerDTOJson("Ana", "ana@test.com", "1998-11-05", "FEMALE", null, "DATA_SCIENCE", 11, "MIDFIELDER")))
                .andExpect(status().isBadRequest());
    }
    ...
    void testCreateSportsProfileGraduateWithPhoto_returns201() throws Exception {
        ...
        MockMultipartFile playerPart = new MockMultipartFile(
                "player", "", MediaType.APPLICATION_JSON_VALUE,
                graduatePlayerDTOJson("Ana", "ana@test.com", "1998-11-05", "FEMALE", "pass", "DATA_SCIENCE", 11, "MIDFIELDER").getBytes());
        MockMultipartFile photoPart = new MockMultipartFile(
                "profilePicture", "test.jpg", MediaType.IMAGE_JPEG_VALUE, imagenBytes);

        mockMvc.perform(multipart("/api/players/graduates/sports-profile").file(playerPart).file(photoPart))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileGraduateWithPhoto_withoutPhoto_returns201() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/graduates/sports-profile").file(playerPart).file(fotoVacia))
                .andExpect(status().isCreated());
    }
    ...
    void testCreateSportsProfileGraduateWithPhoto_corruptedImage_returns400() throws Exception {
        ...
        mockMvc.perform(multipart("/api/players/graduates/sports-profile").file(playerPart).file(fotoCorrupta))
                .andExpect(status().isBadRequest());
    }
    ...
    void testGetPlayerByUserId_returns200() throws Exception {
        ...
        mockMvc.perform(get("/api/players/u1")).andExpect(status().isOk());
    }
    ...
    void testGetPlayerByUserId_notFound_returns404() throws Exception {
        ...
        mockMvc.perform(get("/api/players/u99")).andExpect(status().isNotFound());
    }
