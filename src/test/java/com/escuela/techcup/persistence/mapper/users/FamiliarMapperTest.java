...
class FamiliarMapperTest {
    ...
    void toModel_and_toEntity_areConsistent() {
        ...
        entity.setId("fam-1");
        entity.setName("Fam Test");
        entity.setMail("fam@test.com");
        entity.setDateOfBirth(LocalDate.of(1994, 4, 4));
        entity.setGender(Gender.FEMALE);
        entity.setPasswordHash("hashedpass");
        entity.setRoles(Set.of(UserRole.BASEUSER));

        Familiar model = FamiliarMapper.toModel(entity);
        FamiliarEntity mappedEntity = FamiliarMapper.toEntity(model);
