...
class RefereeMapperTest {
    ...
    void toModel_and_toEntity_areConsistent() {
        ...
        entity.setId("ref-1");
        entity.setName("Ref Test");
        entity.setMail("ref@test.com");
        entity.setDateOfBirth(LocalDate.of(1993, 3, 3));
        entity.setGender(Gender.MALE);
        entity.setPasswordHash("hashedpass");
        entity.setRoles(Set.of(UserRole.REFEREE));

        Referee model = RefereeMapper.toModel(entity);
        RefereeEntity mappedEntity = RefereeMapper.toEntity(model);
