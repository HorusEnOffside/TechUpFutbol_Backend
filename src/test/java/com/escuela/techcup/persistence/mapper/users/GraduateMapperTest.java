...
class GraduateMapperTest {
    ...
    void toModel_and_toEntity_areConsistent() {
        ...
        entity.setId("grad-1");
        entity.setName("Grad Test");
        entity.setMail("grad@test.com");
        ...
        Graduate model = GraduateMapper.toModel(entity);
        GraduateEntity mappedEntity = GraduateMapper.toEntity(model);
